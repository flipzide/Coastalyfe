...
public final class LocationUtils {
    ...
    public static final String SHARED_PREFERENCES = "com.example.android.location" +
            ".SHARED_PREFERENCES";

    // Key for storing the "updates requested" flag in shared preferences
    public static final String KEY_UPDATES_REQUESTED = "com.example.android.location" +
